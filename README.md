...
Practice immediately displays one random question from the five built-in questions and published course questions. Questions with no previous attempt take priority, regardless of whether earlier answers were correct. Once every question has been attempted, practice picks randomly from the full pool. Shuffle question and Next question avoid repeating the current question when another question at the same priority is available. Signed-in learners use their saved history; anonymous practice remembers up to 200 answered question IDs only in memory for the current visit. Publishing makes questions and their feedback available to everyone; original documents and unpublished drafts are accessible only to admins. Practice history remains private to the learner.
